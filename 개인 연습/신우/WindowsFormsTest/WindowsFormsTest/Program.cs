...
namespace UserInputWalkthrough
{
    public class Form1 : Form
    {
        ...
        //폼에 포함 된 모든 체크 박스를 재귀 적으로 검색하고 처음 체크합니다.
        ...
        //텍스트 상자 중 하나에 텍스트 줄을 표시하는 다목적 방법입니다.
            ...
            MouseEventArgs e)
        {
            ...
            //TextBox 컨트롤은 기본 클릭에서만 포커스를 변경하도록 설계되었으므로 사용자의 혼란을 피하기 위해 포커스를 강제로 적용하십시오.
